...
parser.add_argument('--results_dir', default='./Output', type=str)

eval_type_dict = {
    "Perception": ["existence", "count", "position", "color", "posters", "celebrity", "scene", "artwork", "OCR"],
    "Cognition": ["numerical_calculation", "text_translation", "code_reasoning"]
}
...
class calculate_metrics:
    ...
    def process_result(self, results_dir):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            print("total score:", f"{scores:.2f}", "\n")
            for task_name, score in task_score_dict.items():
                print("\t", task_name, " score:", f"{score:.2f}")
            print("\n")
